...
function App() {
  ...
  const exercises = [
    { id: 'python_001', name: 'Python: Soma de Dois Números', course: 'PYTHON' },
    { id: 'python_002', name: 'Python: Média de Três Notas', course: 'PYTHON' },
    { id: 'python_003', name: 'Python: Par ou Ímpar', course: 'PYTHON' },
    { id: 'js_001', name: 'JavaScript: Dobro de um Número', course: 'JAVASCRIPT' },
    { id: 'js_002', name: 'JavaScript: Encontrar o Maior', course: 'JAVASCRIPT' },
    ...
    <div className="App">
      ...
      <header className="app-header">
        <div className="header-content">
          ...
          <p>Sistema de Validação de Código - Estilo DIO/LeetCode</p>
        </div>
      </header>
      ...
      <footer className="app-footer">
        <p>Desenvolvido por <strong>Diego Rapichan</strong> 💻</p>
        <p>Sistema de Validação de Código - 2025</p>
      </footer>
    </div>
  );
}
